...
Issue #11's dispatch died exactly this way: 59 of 80 turns, 17 minutes, $2.76,
`success`, nothing to show for it. If a check is slow, give the foreground call
a generous `timeout` and let it block — blocking is the point.
